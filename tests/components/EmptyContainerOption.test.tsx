...
describe('EmptyContainerOption', () => {
  it('renders checkbox label text', () => {
    render(<EmptyContainerOption checked={false} categoryColor="#C2410C" onChange={vi.fn()} />);
  ...
  it('checkbox is checked when checked prop is true', () => {
    render(<EmptyContainerOption checked={true} categoryColor="#C2410C" onChange={vi.fn()} />);
    const checkbox = screen.getByRole('checkbox');
  ...
  it('calls onChange when checkbox clicked', () => {
    ...
    render(<EmptyContainerOption checked={false} categoryColor="#C2410C" onChange={handleChange} />);
  ...
  it('has no accessibility violations unchecked', async () => {
    const { container } = render(
      <EmptyContainerOption checked={false} categoryColor="#C2410C" onChange={vi.fn()} />
    );
  ...
  it('has no accessibility violations checked', async () => {
    const { container } = render(
      <EmptyContainerOption checked={true} categoryColor="#C2410C" onChange={vi.fn()} />
    );
    const results = await axe(container);
    expect(results).toHaveNoViolations();
  });
