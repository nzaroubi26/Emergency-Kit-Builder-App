...
| 2026-03-11 | 2.3 | Phase 2.7: Epic 12 (Inline Pricing Display) complete — per-item prices on ItemCard, container prices on EmptyContainerOption, item prices and line totals on SubkitSummarySection, live subkit subtotals on ItemConfigScreen and CustomSubkitScreen, subkit subtotals on SummaryScreen and OrderConfirmationScreen. Zero store changes, zero new routes, zero new env vars. | Sarah, PO |
